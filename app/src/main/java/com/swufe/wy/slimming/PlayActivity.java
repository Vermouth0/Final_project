...
public class PlayActivity extends AppCompatActivity {
    ...
    private static String str[] = {"狼人杀", "剧本杀", "密室逃脱"};
    private static int pics[] = {R.drawable.langrensha, R.drawable.jubensha,R.drawable.mishi}; //以int型定义图片资源
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text = findViewById(R.id.tv_play);
        img = findViewById(R.id.im_play);
